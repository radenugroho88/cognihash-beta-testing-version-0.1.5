  ...
  const problemPoints = [
    {
      ...
      description: "Blockchain data scattered across multiple sources, making comprehensive analysis nearly impossible.",
      icon: (
    ...
    },
    {
      ...
      description: "Time-consuming manual processes that delay critical decision-making in fast-moving markets.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Complex Tools",
      description: "Existing solutions require extensive technical knowledge, limiting accessibility for most users.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const solutionPoints = [
    {
      ...
      description: "AI agents automatically aggregate and correlate data from all blockchain sources.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Real-time analysis powered by AI delivers insights in seconds, not hours.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Simple conversational interface - just ask questions in plain English.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed mt-6">
            Traditional blockchain analysis creates more problems than it solves. 
            <span className="text-cognihash-tertiary font-medium"> We're changing that.</span>
          </p>
        </div>
            ...
            <div className="sticky top-8">
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-10">
                ...
                <div className="relative z-10">
                  <h3 className={`text-center text-xl font-bold mb-8 transition-colors duration-500 ${
                    activeTab === 'problems' ? 'text-red-300' : 'text-cognihash-tertiary'
                  }`}>
                    {activeTab === 'problems' ? 'Current State: Fragmented' : 'CogniHash: Unified'}
                  </h3>
                  
                  {/* Central Visualization */}
                  <div className="relative w-48 h-48 mx-auto mb-8">
                    {/* Central Hub */}
                    <div className={`absolute inset-8 rounded-full border-2 flex items-center justify-center transition-all duration-1000 ${
                      activeTab === 'problems'
                      ...
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-500 ${
                        ...
                        {activeTab === 'problems' ? (
                          ...
                          <svg className="w-8 h-8 text-cognihash-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                          </svg>
                        )}
                      </div>
                  ...
                  <div className="text-center">
                    <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border transition-all duration-500 ${
                      ...
                      <div className={`w-2 h-2 rounded-full ${
                        activeTab === 'problems' ? 'bg-red-400 animate-pulse' : 'bg-cognihash-secondary animate-ping'
                      }`}></div>
                      <span className="text-sm font-medium">
                        {activeTab === 'problems' ? 'Disconnected & Complex' : 'Connected & Simple'}
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="relative z-10 flex items-start gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className={`text-xl lg:text-2xl font-bold mb-3 transition-colors duration-300 ${
                          hoveredIndex === index ? 'text-cognihash-tertiary' : 'text-white'
                        }`}>
                          {item.title}
                        </h4>
                      ...
                      <div className="text-right flex-shrink-0">
                        <div className={`text-2xl lg:text-3xl font-bold transition-colors duration-300 ${
                          activeTab === 'problems' ? 'text-red-400' : 'text-cognihash-secondary'
                        }`}>
                          {item.metric}
                        </div>
                        <div className={`text-xs text-white/60 mt-1 transition-colors duration-300 ${
            ...
            <div className="bg-gradient-to-r from-cognihash-primary to-cognihash-secondary p-1 rounded-2xl">
              <div className="bg-cognihash-dark rounded-2xl px-8 py-6">
                ...
                <p className="text-cognihash-tertiary text-lg">
                  Join thousands who've already transformed their blockchain analysis workflow.
                </p>
              </div>
            </div>
          </div>
