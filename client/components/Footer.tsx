...
export function Footer() {
  return (
    <footer 
      ...
      style={{
        background: "linear-gradient(180deg, rgba(14, 21, 26, 0.75) 0%, #134156 28.07%, #00B49F 75%)"
      }}
    >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-white text-lg hover:text-cognihash-secondary transition-colors">
                  CogniHash AI
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white text-lg">All systems operational</span>
            </div>
